...
Currently I am rebuilding my [portfolio page](https://github.com/SamuelAdamson/portfolio-redesign). The site will be more dynamic in nature - API built with AWS Lambda and DynamoDB to display user metrics for GitHub and Leetcode. This project will be built primarily using TypeScript, Next, and React. Additionally, I am working on improving my competitive programming skills- [Zero to Hero](https://github.com/SamuelAdamson/zero-to-hero). Last but certainly not least, during the Fall 2023 semester I will be researching the application of deep learning on [Fuzzing](https://en.wikipedia.org/wiki/Fuzzing) for industrial control systems. 
