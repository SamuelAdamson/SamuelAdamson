...
Currently I am rebuilding my [portfolio page](https://github.com/SamuelAdamson/portfolio-2.0). The site will be more dynamic in nature - API built with Google Cloud Functions, Cloud Run, and API Gateway to display user metrics for GitHub and Leetcode. This user interface will be built using TypeScript and React. Additionally, I am working on improving my competitive programming skills- [Zero to Hero](https://github.com/SamuelAdamson/zero-to-hero).
